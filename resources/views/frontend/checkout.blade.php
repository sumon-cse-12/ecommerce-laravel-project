                    ...
                    <div class="card cart-summery">
                        <div class="card-body">  
                         @if (session()->has('cart'))
                            ...
                            <input type="hidden" name="price" value="{{$item['price'] * $item['quantity']}}">                
                            <input type="hidden" name="shipping" value="0">                
                            <input type="hidden" name="sub_total" value="{{$item['price'] * $item['quantity']}}">                
                            <div class="d-flex justify-content-between summery-end">
                                <div class="h6"><strong>Subtotal</strong></div>
                                <div class="h6"><strong>৳ {{$item['price'] * $item['quantity']}}</strong></div>
                            </div>
                            ...
                            <div class="d-flex justify-content-between mt-2 summery-end">
                                ...
                                <div class="h5"><strong>৳ {{$item['price'] * $item['quantity']}}</strong></div>
                            </div>                            
                        </div>
                    </div>   
