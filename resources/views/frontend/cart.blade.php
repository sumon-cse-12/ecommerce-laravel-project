                    ...
                    <table class="table" id="cart">
                       ...
                       @endphp
                               @foreach ($cart_products as $key => $cart_product )
                                    @php
                                        $total_price = $total_price + $cart_product['price'] * $cart_product['quantity'];
                                    @endphp
                               <tr>
                                <td>
                                    <div class="d-flex align-items-center justify-content-center">
                                        <img src="images/product-1.jpg" width="" height="">
                                        <h2>{{isset($cart_product['name'])?$cart_product['name']:'' }}</h2>
                                    </div>
                                </td>
                                <td>৳{{isset($cart_product['price'])?$cart_product['price']:'' }}</td>
                                <td>
                                ...
                                <td>
                                    ৳{{isset($cart_product['price']) && $cart_product['quantity'] ? $cart_product['price'] * $cart_product['quantity']:''}}
                                </td>
                                <td>
