<div class="row">
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="text" value="{{isset($product)?$product->slug:(old('slug'))}}" name="slug" id="slug" class="form-control" placeholder="Slug">	
        </div>
    </div>	
    <div class="col-md-6">
        <div class="mb-3">
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <textarea name="description" id="" cols="4" rows="4"class="form-control" placeholder="Description">{{isset($product)?$product->description:(old('description'))}}</textarea>
        </div>
    </div>									
    <div class="col-md-6">
        <div class="mb-3">
            <label for="email">Short Description</label>
            <textarea name="short_description" id="" cols="4" rows="4"class="form-control" placeholder="Short Description">{{isset($product)?$product->short_description:(old('short_description'))}}</textarea>
        </div>
    </div>									
